...
public final class ACominicioDecFuncao extends PDecFuncao
{
    ...
    public Object clone()
    {
        return new ACominicioDecFuncao(
    ...
    {
        ((Analysis) sw).caseACominicioDecFuncao(this);
    }
