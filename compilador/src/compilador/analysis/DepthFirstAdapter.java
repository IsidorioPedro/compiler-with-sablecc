...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAMultiplicaFator(AMultiplicaFator node)
    {
        defaultIn(node);
    }

    public void outAMultiplicaFator(AMultiplicaFator node)
    {
        defaultOut(node);
    }
