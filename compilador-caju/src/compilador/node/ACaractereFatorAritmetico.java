...
public final class ACaractereFatorAritmetico extends PFatorAritmetico
{
    private TCaractere _caractere_;

    public ACaractereFatorAritmetico()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACaractereFatorAritmetico(
    ...
    {
        ((Analysis) sw).caseACaractereFatorAritmetico(this);
    }
