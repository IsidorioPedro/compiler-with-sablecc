...
public final class AChamadaFatorAritmetico extends PFatorAritmetico
{
    private PChamada _chamada_;

    public AChamadaFatorAritmetico()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaFatorAritmetico(
    ...
    {
        ((Analysis) sw).caseAChamadaFatorAritmetico(this);
    }
