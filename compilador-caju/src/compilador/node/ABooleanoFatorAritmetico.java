...
public final class ABooleanoFatorAritmetico extends PFatorAritmetico
{
    private TBooleano _booleano_;

    public ABooleanoFatorAritmetico()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABooleanoFatorAritmetico(
    ...
    {
        ((Analysis) sw).caseABooleanoFatorAritmetico(this);
    }
