...
public final class AExpEntreColchetes extends PExpEntreColchetes
{
    private TAbreColchete _abreColchete_;
    private PExp _exp_;
    private TFechaColchete _fechaColchete_;

    public AExpEntreColchetes()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAExpEntreColchetes(this);
    }
