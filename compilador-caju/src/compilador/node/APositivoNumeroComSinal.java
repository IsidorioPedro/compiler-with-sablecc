...
public final class APositivoNumeroComSinal extends PNumeroComSinal
{
    private TNumero _numero_;

    public APositivoNumeroComSinal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APositivoNumeroComSinal(
    ...
    {
        ((Analysis) sw).caseAPositivoNumeroComSinal(this);
    }
