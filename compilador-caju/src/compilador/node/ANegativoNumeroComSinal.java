...
public final class ANegativoNumeroComSinal extends PNumeroComSinal
{
    private TNumero _numero_;

    public ANegativoNumeroComSinal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANegativoNumeroComSinal(
    ...
    {
        ((Analysis) sw).caseANegativoNumeroComSinal(this);
    }
