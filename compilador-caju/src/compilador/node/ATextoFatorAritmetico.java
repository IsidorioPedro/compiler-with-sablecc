...
public final class ATextoFatorAritmetico extends PFatorAritmetico
{
    private TTexto _texto_;

    public ATextoFatorAritmetico()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATextoFatorAritmetico(
    ...
    {
        ((Analysis) sw).caseATextoFatorAritmetico(this);
    }
