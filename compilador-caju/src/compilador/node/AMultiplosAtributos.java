...
public final class AMultiplosAtributos extends PMultiplosAtributos
{
    private TVirgula _virgula_;
    private PAtrib _atrib_;

    public AMultiplosAtributos()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplosAtributos(
    ...
    {
        ((Analysis) sw).caseAMultiplosAtributos(this);
    }
