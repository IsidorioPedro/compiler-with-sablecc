...
public final class ABlocoComandoSimples extends PComandoSimples
{
    private PBloco _bloco_;

    public ABlocoComandoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABlocoComandoSimples(
    ...
    {
        ((Analysis) sw).caseABlocoComandoSimples(this);
    }
