...
public final class ANumeroFatorAritmetico extends PFatorAritmetico
{
    private TNumero _numero_;

    public ANumeroFatorAritmetico()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANumeroFatorAritmetico(
    ...
    {
        ((Analysis) sw).caseANumeroFatorAritmetico(this);
    }
