...
public final class AChamadaComandoSimples extends PComandoSimples
{
    private PChamada _chamada_;
    private TPonto _ponto_;

    public AChamadaComandoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaComandoSimples(
    ...
    {
        ((Analysis) sw).caseAChamadaComandoSimples(this);
    }
